    ...
    <div className="font-base ">
      ...
      >
        <main className="c-PJLV">
          <div></div>
          <div className="mx-auto my-0 h-[calc(100vh-93px)] w-full max-w-content overflow-hidden bg-white px-6 pb-6 pt-0">
            <div className="mx-auto h-full max-w-content">
              <div
                className="mb-10 font-title text-title-xl font-medium text-neutral800"
                style={{
                  marginTop: "2rem",
                }}
              >
              ...
              <div className="c-enbXEL c-enbXEL-jnUynx-featured-false">
                ...
                {/* //4 */}
                <div className="relative lt:hidden">
                  <div className="c-cMWDKR"></div>
                </div>
              </div>
              <div className="c-gZNBKH"></div>
            </div>
            {Number(activeUser?.credit) != 0 && (
              <div className="fixed bottom-0 left-0 z-stickyFooter flex h-14 w-full items-center justify-between bg-white px-3 py-2 shadow-high">
                <div className="flex items-center">
                  <a
                    href="/"
                    className="c-bPnuSX c-bPnuSX-eqXekF-size-M c-bPnuSX-hxpvys-variant-secondary c-bPnuSX-ilklqJG-css"
                  >
                    Cancel
                  </a>
                </div>
                <button
                  ...
                  className="c-bPnuSX c-bPnuSX-eqXekF-size-M c-bPnuSX-kiaVWo-variant-primary"
                >
                  Create
                </button>
              </div>
