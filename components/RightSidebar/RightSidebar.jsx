          ...
          <div className="flex h-full flex-col justify-between gap-10">
            ...
            <div className="mb-20 flex flex-col">
              ...
              <div className="flex items-center justify-center gap-4 text-neutral400">
                <Link icon={<Twitter />} link={"https://twitter.com/REDLIGHTWEB3"} />
                <Link icon={<Instagram />} link={"https://www.youtube.com/channel/UC-yNSpSf2rRbpvWNtCeneJQ"} />
                <Link icon={<Discord />} link={"https://discord.gg/7vucPYcsCZ"} />
                <Link icon={<Store />} link={"https://opensea.io/collection/redlightweb3"} />
              </div>
