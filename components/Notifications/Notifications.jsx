    ...
    <div className="min-w-0 flex-1">
      <div className="flex w-full flex-1 flex-col">
        ...
        <div className="z-above1 flex w-full flex-col">
          ...
          <h3 className="mt-4">💰 Step 2: Earn MP9 Tokens</h3>
          <p className="mt-4">
            For every 10 tracks you listen to, you'll earn MP9 tokens as a
          ...
          <p className="mt-4">
            ...
            MP9 tokens. Simply navigate to the rewards section of our platform
          ...
          <p className="mt-4">
            ...
            discovering hidden gems, and accumulating MP9 tokens along the way.
